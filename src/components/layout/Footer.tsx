...
const DEFAULT_FOOTER = {
  ...
  newsletterDisclaimer: 'Get weekly tech insights and product updates. Unsubscribe anytime.',
  section1Title: 'Solutions',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 Acme Tech. All rights reserved.',
  madeWithText: 'by our engineering team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/acmetech',
  social2Href: 'https://facebook.com/acmetech',
  social3Href: 'https://instagram.com/acmetech',
  social4Href: 'https://linkedin.com/company/acmetech',
  social5Href: 'https://github.com/acmetech',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'AI Analytics', href: '/analytics', editableId: 'link-footer-analytics' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Technical Tutorials', href: '/tutorials', editableId: 'link-footer-tutorials' },
        ...
        { name: 'Support Center', href: '/support', editableId: 'link-footer-support-center' },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'Security Policy', href: '/security-policy', editableId: 'link-footer-security' },
